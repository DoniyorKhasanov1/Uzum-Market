...
<head>
    ...
    <style>
        ...
        * {
        ...
        /*Kirish formasi logosi uchun*/
        .logo-img {
            max-width: 180px;
            height: auto;
        }

        /*Kirish formasi h2 uchun*/
        .modal h2 {
            color: black;
            font-size: 22px;
            font-weight: bold;
        ...
        /*Kirish formasi button uchun design*/
                        ...
                        <div class="product-image-container">
                            ...
                            <c:if test="${product.oldPrice > 0 && product.price < product.oldPrice}">
                                <div class="discount-badge">
                                    -<fmt:formatNumber
                                        value="${(product.oldPrice - product.price) / product.oldPrice * 100}"
                                        pattern="0"/>%
                                </div>
                            </c:if>
...
<script>
    ...
    //Kirish button uchun modal chiqarish JS kod
